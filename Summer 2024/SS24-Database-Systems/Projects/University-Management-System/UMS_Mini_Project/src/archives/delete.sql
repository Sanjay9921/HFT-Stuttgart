import java.sql.*;
/* We assume the existence of a class KeyboardInput providing class methods
for reading various data types, here a String. */
public class Student {
    public static void main(String[] args) throws SQLException {
        ...
        Connection conn = DriverManager.getConnection(
                "jdbc:mysql://193.196.143.168/koch_universitydb", user, password
        );
